...
exports.VERB_ES_SUFFIXES = void 0;
...
function pluralize(verb) {
    if (verb.endsWith('ies')) {
        return verb.substring(0, verb.length - 3) + 'y';
    }
    for (var _i = 0, VERB_ES_SUFFIXES_2 = exports.VERB_ES_SUFFIXES; _i < VERB_ES_SUFFIXES_2.length; _i++) {
        var suffix = VERB_ES_SUFFIXES_2[_i];
        if (verb.endsWith(suffix)) {
            return verb.substring(0, verb.length - 2);
        }
    }
